...
/*
 * Plugin Name: Pardot
 * Description: Connect your WordPress site to Pardot for campaign tracking, displaying forms, and adding dynamic content.
 * Author: Salesforce
...
function pardot_init() {
    ...
    wp_localize_script( 'build/index.js', 'Pardot', array( 'ajaxurl' => admin_url( 'includes/admin-ajax.php' ) ) );
